...
/**
 * Not wired to real Google auth yet — clicking it just surfaces a
 * "coming soon" note and leaves the guest to continue below, per the
 * approved design. Swap the onClick for the real OAuth kickoff when
 * that's built; the coming-soon note goes away in the same change.
 */
